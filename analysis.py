...
from logistic_regression.logistic_regression import model
...
model(x_train, y_train, x_test, y_test, num_iterations=20000, learning_rate=0.0001, print_cost=True)
